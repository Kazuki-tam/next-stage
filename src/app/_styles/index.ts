...
export const styles = {
  ...
  // Card styles
  cards: {
    feature: "bg-[#111] p-6 rounded-xl border border-[#333] hover:border-[var(--blue-primary)] transition-all duration-300 hover:shadow-[0_0_15px_var(--blue-shadow)] group flex flex-col",
